...
| list | <pre>/** Unordered list(bullet list)<br>  *    - first item<br>  *    - second item<br>  *        - sub item<br>  *        - another sub item<br>  *    - third item<br>  *<br>  * Ordered list(Numbered list)<br>  *    1. first item<br>  *    1. second item<br>  *        i. sub item<br>  *        i. another sub item<br>  *    1. third item<br>  *<br>  */</prev>|
